...
Sub Test()
    ...
    Dim callResult As WebStatusCode
        ...
        Debug.Print (Now())
            callResult = funcGetSprintWorkLog(TeamResourcesString, CStr(ws_VelocityData.Range("F2").Value), CStr(ws_VelocityData.Range("A2").Value))
...
If funcPostTeamsFind = OK Then
    ...
    Dim Arr As Variant
    ReDim Arr(1 To 7, 1 To 1) As Variant 'initial size
...
If funcGetSprintWorkLog = OK Then
    r = 2
    i = 1 'reset the issue to 1
    ws_Work.Range("F:S").ClearContents ' Clear previous contents
...
With ws_TeamStats
    ...
    .Range("AB24").Value = Round(avgActiveTime_days / avgLeadTime_days, 2)
End With
End Function
...
With ws_TeamStats
    ...
    .Range("AM30").Value = Round(countOfDefects / countOfManDays, 2)
End With
End Function
